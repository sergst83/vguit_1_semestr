# как "создать вкладки с отступом друг от друга (равномерно распределить по окну)" я так и не разобрался.
# Особенно в части отступа между вкладками. Ширину можно через стили изменить, но там все становится совсем некрасиво.
